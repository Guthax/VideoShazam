...
def smooth(trajectory, smoothingRadius): 
  smoothed_trajectory = np.copy(trajectory) 
  # Filter the x, y and angle curves
  for i in range(3):
    smoothed_trajectory[:,i] = movingAverage(trajectory[:,i], radius=smoothingRadius)
...
def stabilizeVideo(video, output):
    ...
    smoothed_trajectory = smooth(trajectory, smoothingRadius) 
